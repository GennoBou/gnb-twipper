...
This document describes the design, implementation, and extension guidelines for the GUI localization (i18n) system in `gnb-twipper`.
...
- **Directory**: `frontend/src/locales/`
  - Localization profiles are decoupled into standalone `.json` files:
    - [ja.json](file:///D:/Data/Projects/GitHub/gnb-twipper/frontend/src/locales/ja.json) (Japanese)
    - [en.json](file:///D:/Data/Projects/GitHub/gnb-twipper/frontend/src/locales/en.json) (English)
